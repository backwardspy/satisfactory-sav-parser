...
impl PartialEq<&str> for ADAString {
    fn eq(&self, other: &&str) -> bool {
        match self {
            ADAString::Empty => other.is_empty(),
            ADAString::UTF8(string) => String::from_utf8_lossy(string) == *other,
            ADAString::UTF16(string) => String::from_utf16_lossy(string) == *other,
        }
    }
}
